export const projects = [
  ...
  {
    title: 'LifeQuest',
    description: "A JavaFX based desktop application that lets users 'gamify' their real life tasks and rewards them with 'experience points' or XP based on completion of said tasks. ",
      image: 'https://i.ibb.co/VpGKg08/LQ.png',
      tags: ['Java', 'JavaFX', 'HTML/CSS', 'mySQL'],
    source: '',
    visit: 'https://github.com/Sheersho98/JavaFX-LifeQuest',
    id: 2,
  },
];
